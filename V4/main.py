...
if __name__ == "__main__":
    ...
    args = {
        ...
        "root_noise_eps": 0.25,        # Dirichlet alla root (CPU-safe)
        ...
        # --- Surrogato progressivo (opzionale: default in MCTS) ---
        # lista di stage: (nsamples, seq_len) — 'full' usa i valori calib
        # "prog_stages": [(1, 32), (2, 64), ("full", "full")],
        # "prog_policy": "by_depth",         # "by_depth" | "by_sparsity"
        # "prog_steps_per_stage": 2,         # per "by_depth": ogni N depth si avanza di stage

        # --- Parallel / Esperimenti ---
        "parallel": True,              # True = self-play parallelo; False = sequenziale
        "parallel_workers": 4,         # num thread per il self-play (usato solo se parallel=True)
        "exp_id": 1,                   # numero esperimento: usato come suffisso file
    }
